/* Action code -- generated by iset.tcl */
          ...
          ACTION(ADJUST_1)
               pc = pc0 + 2;
               sp[0].a = sp[0].a + (get1(pc0+1));
               NEXT;

          ACTION(ADJUST_2)
               pc = pc0 + 3;
               sp[0].a = sp[0].a + (get2(pc0+1));
               NEXT;
          ...
          ACTION(JEQ_S)
               pc = pc0 + 2;
               condj(sp[1].i==sp[0].i, (get1(pc0+1))); sp += 2;
               NEXT;

          ACTION(JEQ_R)
               pc = pc0 + 3;
               condj(sp[1].i==sp[0].i, (get2(pc0+1))); sp += 2;
               NEXT;
          ...
          ACTION(JNEQZ_S)
               pc = pc0 + 2;
               condj(sp[0].i != 0, (get1(pc0+1))); sp += 1;
               NEXT;

          ACTION(JNEQZ_R)
               pc = pc0 + 3;
               condj(sp[0].i != 0, (get2(pc0+1))); sp += 1;
               NEXT;
 ...
 sp++;
          ...
          ACTION(CONVDQ)
               pc = pc0 + 1;
               putlong(&sp[0], long_convq(getdbl(&sp[0])));
               NEXT;
 ...
 sp += 3;
     ...
     breakpoint(cp, bp, pc0, "break");
          ...
          ACTION(CASEJUMP_1)
               pc = pc0 + 2;
               casejump(sp[0].i, (get1(pc0+1))) sp += 1;
               NEXT;

          ACTION(PACK)
               pc = pc0 + 1;
               sp[1].i = pack(valptr(sp[0]), pointer(sp[1])); sp++;
               NEXT;

          ACTION(UNPACK)
               pc = pc0 + 1;
               sp--; sp[0].a = dsegaddr(getcode(sp[1].i)); 
                      sp[1].a = stkaddr(getenvt(sp[1].i));
               NEXT;
